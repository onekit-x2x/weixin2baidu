...
export default class wx {
  ...
  static base64ToArrayBuffer(base64) { return swan.base64ToArrayBuffer(base64) }

  static arrayBufferToBase64(arrayBuffer) { return swan.arrayBufferToBase64(arrayBuffer) }
  ...
  static createVideoContext(videoId) { return new VideoContext(swan.createVideoContext(videoId)) }

  static createInnerAudioContext(audioId) { return new InnerAudioContext(swan.createInnerAudioContext(audioId)) }

  static createLivePlayerContext(livePlayerId) { return new LivePlayerContext(swan.createLivePlayerContext(livePlayerId)) }
  ...
  static _getBatteryInfo(object) { return swan._getBatteryInfo(object) }
  ...
  static onGyroscopeChange(callback) { return swan.onGyroscopeChange(callback) }
  ...
  //
  static getNetworkType(object) { return swan.getNetworkType(object) }

  static _network(res) { return swan._network(res) }

  static onNetworkStatusChange(object) { return swan.onNetworkStatusChange(object) }

  //
  static makePhoneCall(object) { return swan.makePhoneCall(object) }

  static scanCode(object) { return swan.scanCode(object) }
  ...
  //
  static stopBluetoothDevicesDiscovery() { /* return swan.stopBluetoothDevicesDiscovery(object); */ }

  static startBluetoothDevicesDiscovery(object) { return swan.startBluetoothDevicesDiscovery(object) }

  static openBluetoothAdapter() { /* return swan.openBluetoothAdapter(object); */ }
  ...
  static chooseMessageFile() { return console.log('暂不支持！') }// swan.chooseMessageFile(object)
  // //////////////////////////////////////////////////////////////
  ...
  static chooseMedia() { return console.log('暂不支持！') }
  ...
  static getOpenData(object) { return swan.getOpenData(object) }

  static getPhoneNumber(object) { return swan.getPhoneNumber(object) }
  ...
  static addCard(object) { return swan.addCard(object) }
  ...
  static setNavigationBarTitle(object) { return swan.setNavigationBarTitle(object) }
  ...
  static loadFontFace() { return console.log('注释了') }// swan.loadFontFace(object)
